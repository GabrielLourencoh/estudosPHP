                ...
                <form action="" method="POST">
                    <div class="form-group row">
                        <div class="col-12 col-sm-6">
                            <input type="text" class="form-control form-control-lg" name="elefante" id="elefante" placeholder="Qtde de elefantes">
                        </div>
                        <div class="col-12 col-sm-6">
            ...
            <div class="col-12 col-sm-10 alert alert-info">
                <?php
                    if (isset($_POST['elefante'])){
                        $elefante = $_POST['elefante'];
                        for ($j = 1; $j <= $elefante; $j++){
                            if ($j % 2 == '0'){
                                ...
                                echo '<p class="text-dark">'.$j.' elefantes incomodam muita gente...</p>';
                            }
                        }
                    } else {
